...
var hotSale = app.controller('hotSaleCtrlOne', function ($scope, $stateParams, $location, $rootScope, productService) {
    ...
    /************专区01************/
    if ($stateParams.id == 1) {
        $rootScope.titleTab = "开学精选"+ '-' + $rootScope.titleMall;
        /*
         * 寝室*/
       ...
       * 新品必备*/
        ...
        /*
         * 户外运动*/
        var pIds23 = ['7147529', '4325170', '7534083', '4577137', '7703417', '6509943'];
        $scope.product23 = [];
    ...
    /* ***************专区05****************/
    if ($stateParams.id == 5) {
        $rootScope.titleTab = "福利专享" + '-' + $rootScope.titleMall;
        /*
       * 精选礼盒**/
    ...
    /************专区06************/
    if ($stateParams.id == 6) {
        $rootScope.titleTab = "食品饮料" + '-' + $rootScope.titleMall;
        /*
       *  酒水饮料*/
    ...
    /* ***************专区08****************/
    if ($stateParams.id == 8) {
        $rootScope.titleTab = "电脑办公"+ '-' + $rootScope.titleMall;
        /*
        * 台式机**/
        ...
        // *Mac专区*
        var pIds93 = ['5225340', '4335045', '4331183', '4331185', '4331143', '5225342', '4335133', '4331151', '5225340', '4335021', '4335131', '4335105', '4334877'];
        $scope.product93 = [];
    ...
    * 平板酷玩**/
    ...
    /* ***************专区09****************/
    if ($stateParams.id == 9) {
        $rootScope.titleTab = "电脑配件" + '-' + $rootScope.titleMall;
     // 高清大屏
    ...
    if ($stateParams.id == 10) {
        $rootScope.titleTab = "办公设备"+ '-' + $rootScope.titleMall;
        /*
       * 多功能一体机*/
       ...
       * 办公室之选*/
        ...
        /*
      * 机构之选*/
        var pIds115 = ['5756296', '5756276', '5756322', '3244132', '2927842','10064731907'];
        $scope.product115 = [];
    ...
    if ($stateParams.id == 11) {
        $rootScope.titleTab = "数码配件" + '-' + $rootScope.titleMall;
        /*
       * 热销商品*/
        ...
        /*
        *  配件专区*/
        var pIds94 = ['3563660', '1861424', '6518073', '771920', '4406753', '28786010829', '27425521862', '24869631535'];
        $scope.product94 = [];
    ...
    if ($stateParams.id == 12) {
        $rootScope.titleTab = "手机通讯" + '-' + $rootScope.titleMall;
     // 品牌爆品
